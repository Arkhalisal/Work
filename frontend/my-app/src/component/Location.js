    ...
    const filteredLocations = locationData
      .filter((location) => {
        return (
          ...
          (String(location.count).includes(searchTerm) && location.count > 3 && location.latitude) // Filter by distance
        );
      })
      .slice(0, 10)
      .filter((location) => {
  ...
  return (
    <div className="locations-container">
      <div className="locations-content">
        <h1 className="locations-title" style={{ color: lightMode ? "black" : "white" }}>
          Location Page
        </h1>
        ...
        <div className="locations-distance-slider">
          <label htmlFor="distance" style={{ color: lightMode ? "black" : "white" }}>
        ...
        <div className="locations-sorting" style={{ marginBottom: "15px" }}>
          <label htmlFor="sort" style={{ color: lightMode ? "black" : "white" }}>
            Sort by:{" "}
          </label>
          <select
            id="sort"
